...
### 이론
행 편집 방법은 두가지 방법이 존재합니다. 그리드에서 직접 입력장치를 통하여 편집하는 방법있고. 리얼그리드에서 제공하는 API를 사용하여 편집하는 방법이 있습니다.  
...
beginUpdateRow()는 해당 행을 편집 모드로 바꾸기만 하지 편집기가 표시 되지는 않습니다. 편집기까지 표시하고 싶으면 [GridBase.showEditor()](/api/GridBase/showEditor/)를 호출하셔야 합니다.
