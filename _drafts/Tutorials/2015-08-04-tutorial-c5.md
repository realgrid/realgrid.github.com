---
layout: post
title: C5 행의 상태 또는 셀의 값에 따른 editable의 변경
date: 2015-08-04 10:01:31 +9:00 GMT
...
이번 강좌에서는 행의 상태 또는 다른 컬럼의 값에 따라서 셀을 수정하거나 수정할수 없도록 변경하는 것에 대해서 배워보겠습니다.

### 이론

신규행인 경우에만 컬럼의 값을 수정할수 있도록 변경하는 것은 업무프로그램에서  자주 요구 되는 내용중의 하나입니다. RealGrid의 경우 특정 row의 편집여부를 지정할수는 없지만 이벤트를 이용해서 그리드 전체의 editable을 변경하여 처리할수 있습니다.
...
##### [onCurrentRowChagned 이벤트](/api/GridBase/onCurrentRowChanged/)
...
##### [onEditCommit 이벤트](/api/GridBase/onEditCommit/)
...
실습에서는 신규행인 경우에는 모튼 컬럼을 편집할수 있고 기존행인 경우 직업만 편집할수 있도록 코드를 작성하겠습니다.
추가로 직업이 배우인 데이터는 국어컬럼을 수정할수 있도록 만들겠습니다.
