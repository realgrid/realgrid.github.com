...
$(document).ready( function() {
    ...
    $("#button1").click(function(){
    	alert("필드명은 " + dataProvider.getOrgFieldName(0) + "입니다.");
	})

	$("#button2").click(function(){
    	alert("필드명은 " + dataProvider.getOrgFieldName(1) + "입니다.");
	})
...
버튼을 누르면 fieldIndex가 0인 필드에 지정 당시의 필드명을 반환한다.
<br/>
<button id="button2" class="btn btn-success btn-xs">버튼2</button>
버튼을 누르면 fieldIndex가 1인 필드에 지정 당시의 필드명을 반환한다.
