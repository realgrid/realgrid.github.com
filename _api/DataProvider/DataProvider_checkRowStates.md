...
<button id="button1" class="btn btn-success btn-xs">버튼1</button>버튼을 누르면 데이터 수정시 rowState에 상태를 기록한다.
<br/>
<button id="button2" class="btn btn-success btn-xs">버튼2</button>버튼을 누르면 데이터 수정시 rowState에 상태를 기록하지 않는다.
