...
$(document).ready( function() {
    ...
    $("#button1").click(function(){
    	alert("현재 행의 상태는" + dataProvider.getRowState(0) + "입니다.");
    })

    $("#button2").click(function(){
    	alert("현재 행의 상태는" + dataProvider.getRowState(1) + "입니다.");
    })
...
버튼을 누르면 row가 0인 행의 상태 이름을 반환한다.
<br/>
<button id="button2" class="btn btn-success btn-xs">버튼2</button> 
버튼을 누르면 row가 1인 행의 상태 이름을 반환한다. 
