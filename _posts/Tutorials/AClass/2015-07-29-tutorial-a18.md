...
`setColumnFilters(column, filters)`함수는 필터링 할 데이터 컬럼([DataColumn](http://help.realgrid.com/api/types/DataColumn/)) 정보와 [컬럼필터(ColumnFilter)](http://help.realgrid.com/api/types/ColumnFilter/)를 인자로 필터링하는 함수입니다. 자세한 내용은 \[[A19 강좌](/tutorial/a19)\]에서 배워보겠습니다.
