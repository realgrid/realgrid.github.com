---
layout: tutopost
title: C17 Footer를 특정 조건에 맞게 계산하기.
date: 2017-08-03 09:00:31 +9:00 GMT
permalink: /tutorial/c17/
categories:
  - Tutorial
...
이번 강좌에서는 특정 조건에 맞는 데이터만 계산하여 Footer에 표사하는 방법을 배워보도록 하겠습니다.    

### 이론

그리드의 Column Footer에는 Text나 Number Field의 sum, avg, min, max, count 등 특정 연산에 대한 것만 표시할 수 있습니다. (※ [Expression](/api/features/Expression/) 참조)   

업무 화면을 개발하다 보면 Footer에 특정 조건에 맞는 데이터만 처리하여 표시해야 하는 경우도 생길 것 입니다. 
이런 경우 footer.callback 기능을 통해 문제를 해결할 수 있습니다.  
